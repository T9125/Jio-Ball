...
<h3 class="page-title">서비스 이용약관</h3>
</div>
...
<div class="card">
<div class="card-body">
<textarea class="form-control text-secondary terms-of-use" readonly>
제 1조 목적
이 약관은 지오볼 (이하 “회사”)에서 제공하는 회사 및 회사에서 제공하는 제반 서비스(이하 "서비스")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 "회원")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
...
3. 회원은 회사에서 정하고 있는 방법으로 유료서비스의 결제가 가능합니다. 단, 미성년 회원의 결제는 원칙적으로 보호자(법정대리인)의 명의 또는 동의 하에 이루어져야 하고, 보호자(법정대리인)는 본인 동의없이 체결된 자녀(미성년자)의 계약을 취소할 수 있습니다.
